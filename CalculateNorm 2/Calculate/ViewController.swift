...
class ViewController: UIViewController {
    ...
    // В этом месте немного не докрутила - при вертикальной ориентации кнопки выглядят как задумано, но при повороде экрана получается полная ерунда. На досуге поковыряюсь, чтобы исправить это досадное недоразумение, пока не хвалило времени.
